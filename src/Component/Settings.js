...
const Settings = () => {
  return (
    ...
    <div class="w-[461px] h-[146px] left-[247px] top-[312px] absolute flex-col justify-start items-start gap-3 inline-flex">
    ...
    <div class="h-[417px] left-[822px] top-[177px] absolute flex-col justify-start items-center gap-12 inline-flex">
      <div class="self-stretch h-[311px] flex-col justify-start items-center gap-[39px] flex">
        <div class="h-[148px] flex-col justify-start items-center gap-[18px] flex">
          <img class="w-[108px] h-[108px] rounded-full" src="https://via.placeholder.com/108x108" />
          <div class="text-center text-[#cc781d] text-lg font-semibold font-['Inter']">Change Picture</div>
        </div>
        <div class="h-[124px] flex-col justify-start items-start gap-3.5 flex">
          <div class="self-stretch pl-[17px] pr-2.5 py-[18px] bg-[#f8f8f8] rounded-[10px] border border-[#909090] justify-start items-center gap-3 inline-flex">
            <div class="text-[#888888] text-base font-medium font-['Inter']">Ayantoye David</div>
          </div>
          <div class="self-stretch pl-[17px] pr-2.5 py-[18px] bg-[#f8f8f8] rounded-[10px] border border-[#909090] justify-start items-center gap-3 inline-flex">
            <div class="text-[#888888] text-base font-medium font-['Inter']">Web Development</div>
          </div>
        </div>
      </div>
      <div class="self-stretch px-2.5 py-[18px] opacity-60 bg-[#f39b3b] rounded-[10px] justify-center items-center gap-2.5 inline-flex">
